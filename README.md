...
Use Enter or Tab to move through input fields. You can also use click necessary field. Press "Рассчитать бюджет" when finished entries. Press "Обновить расчет" to restart calculation. 
...
5. Click "Рассчитать бюджет". We are done!  At the right-hand side you'll see an output table with your income, expenses and savings, which create your passive income.
